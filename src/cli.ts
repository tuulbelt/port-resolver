...
async function cmdGet(args: ReturnType<typeof parseArgs>): Promise<void> {
  ...
  if (args.registryDir) config.registryDir = args.registryDir;
  if (args.allowPrivileged) config.allowPrivileged = true;
...
async function cmdGetMultiple(args: ReturnType<typeof parseArgs>): Promise<void> {
  if (args.count === undefined || args.count < 1) {
...
async function cmdRelease(args: ReturnType<typeof parseArgs>): Promise<void> {
  const config: Partial<PortConfig> = {};
  if (args.registryDir) config.registryDir = args.registryDir;
  if (args.verbose) config.verbose = true;
...
async function cmdStatus(args: ReturnType<typeof parseArgs>): Promise<void> {
  const config: Partial<PortConfig> = { ...DEFAULT_CONFIG };
  if (args.registryDir) config.registryDir = args.registryDir;
...
async function cmdList(args: ReturnType<typeof parseArgs>): Promise<void> {
  ...
  const registryResult = readRegistry(config as PortConfig);
...
async function cmdClean(args: ReturnType<typeof parseArgs>): Promise<void> {
  const config: Partial<PortConfig> = { ...DEFAULT_CONFIG };
  if (args.registryDir) config.registryDir = args.registryDir;
  if (args.verbose) config.verbose = true;
...
async function cmdReleaseAll(args: ReturnType<typeof parseArgs>): Promise<void> {
  const config: Partial<PortConfig> = { ...DEFAULT_CONFIG };
  if (args.registryDir) config.registryDir = args.registryDir;
  if (args.verbose) config.verbose = true;
...
async function cmdClear(args: ReturnType<typeof parseArgs>): Promise<void> {
  const config: Partial<PortConfig> = { ...DEFAULT_CONFIG };
  if (args.registryDir) config.registryDir = args.registryDir;
  if (args.verbose) config.verbose = true;
