...
import type { Result, PortConfig, PortAllocation, PortEntry, PortRegistry, RegistryStatus } from '../types.js';
...
import { getLockPath, getRegistryPath, ensureRegistryDir, readRegistry, writeRegistry } from '../registry/index.js';
